...
public class CountryCodePicker extends RelativeLayout {
  ...
  private void init(AttributeSet attrs) {
    ...
    mImvFlag.setOnClickListener(mCountryCodeHolderClickListener);
    mTvSelectedCountry.setOnClickListener(mCountryCodeHolderClickListener);

    mImvFlag.setOnTouchListener(new OnTouchListener() {
      @Override
    ...
    mTvSelectedCountry.setOnTouchListener(new OnTouchListener() {
      @Override
      public boolean onTouch(View v, MotionEvent event) {
        showCountryCodePickerDialog();
        return false;
