...
public class LocationMapActivity extends Activity implements View.OnClickListener, OnMapReadyCallback, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void initView() {
        ...
        TextView txtFirst = (TextView) findViewById(R.id.txt_first);
        TextView txtSecond = (TextView) findViewById(R.id.txt_second);
                        ...
                        try {
                            if (response != null) {
                                ...
                                if(results.equals("200")){
                                    ...
                                    showMarkers(false);
                                    MapsInitializer.initialize(LocationMapActivity.this);
                                    //Toast.makeText(LocationMapActivity.this, "tracking" + Constants.orderTrackModel.location, Toast.LENGTH_SHORT).show();
...
//                                        latLngBounds, zoom_out_in));
    ...
    private void directionMap(LatLng source, LatLng des){
        Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                Uri.parse("http://maps.google.com/maps?saddr=" + String.valueOf(source.latitude)+ "," + String.valueOf(source.longitude)+ "&daddr="+ String.valueOf(des.latitude)+","+ String.valueOf(source.latitude) + ""));
