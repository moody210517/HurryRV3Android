...
public class LocationTrackMapActivity extends Activity implements View.OnClickListener, OnMapReadyCallback, GoogleApiClient.OnConnectionFailedListener {
                        ...
                        try {
                            if (response != null) {
                                ...
                                if(results.equals("200")){
                                    ...
                                    showMarkers(false);
                                    MapsInitializer.initialize(LocationTrackMapActivity.this);
